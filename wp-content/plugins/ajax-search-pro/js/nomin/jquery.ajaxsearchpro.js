    ...
    var methods = {
        ...
        initMagnifierEvent: function () {
            ...
            $this.n.text.on('keyup', function(e) {
                ...
                if ( $this.keycode == 13 || ($this.keycode == 13 && enterRecentlyPressed) ) {
                    clearTimeout(rt);

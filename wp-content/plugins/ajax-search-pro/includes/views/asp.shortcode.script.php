...
<?php ob_start(); ?>
{
    ...
    "isotopic": {
        ...
        "itemHeight": <?php echo w_isset_def($style['i_item_height'], 200); ?>,
        "itemHeightTablet": <?php echo w_isset_def($style['i_item_height_tablet'], 200); ?>,
        "itemHeightPhone": <?php echo w_isset_def($style['i_item_height_phone'], 200); ?>,
        "ifNoImage": "<?php echo w_isset_def($style['i_ifnoimage'], 'description'); ?>",

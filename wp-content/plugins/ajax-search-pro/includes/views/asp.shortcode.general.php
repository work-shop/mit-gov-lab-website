...
if ( isset($style['_fo']) ) {
    $_st['_fo']['asp_gen'] = isset($_st['_fo']['asp_gen']) ? $_st['_fo']['asp_gen'] : array();
    $_checked = array(
...
<fieldset class="<?php echo ($field_visible) ? "" : " hiddend"; ?>">
        ...
        <div class="asp_option">
            <div class="asp_option_inner">
                <input type="checkbox" value="<?php echo $fe_field; ?>" id="set_<?php echo $fe_field.$id; ?>"
                       aria-label="<?php echo asp_icl_t("Generic field[".$fe_field."]" . " ($real_id)", $_st['frontend_fields']['labels'][$fe_field]); ?>"
                       name="asp_gen[]" <?php echo $_checked[$fe_field]; ?>/>
                <label aria-hidden="true"
                       for="set_<?php echo $fe_field.$id; ?>"></label>
            </div>
    ...
    <?php else: ?>
        ...
        <select
            aria-label="<?php echo asp_icl_t("Generic fields" . " ($real_id)", "Generic fields"); ?>"
            name="asp_gen[]">
        <?php foreach ( $_st['frontend_fields']['selected'] as $fe_field ): ?>
